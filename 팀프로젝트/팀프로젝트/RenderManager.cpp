...
void RenderManager::RenderManager::Draw(Sprite* pSprite, float x, float y, int dir)
{
	if (pSprite != NULL)
	{
...
void RenderManager::Draw(wstring str, float x, float y, ColorF color,
	int size, ALIGN_TYPE align, wstring fontName)
{
...
void RenderManager::DrawCircle(float x, float y, float width, float height,
	ColorF color, float lineSize)
{
