...
public:
	...
	void SetSkillStatus(SKILL_LIST name)
	{
		switch (name)
		{
		case FIRE_BOLT:			SetSkillStatus(0.001f, 1000, 3, 1, ATTRIBUTE_FIRE, TYPE_BOLT);					break;
		...
		case WATER_BOLT:		SetSkillStatus(0.001f, 1000, 3, 1, ATTRIBUTE_WATER, TYPE_BOLT);				break;
		...
		case ELECTRICITY_BOLT:	SetSkillStatus(0.001f, 1000,3, 1, ATTRIBUTE_ELECTRICITY, TYPE_BOLT);			break;
